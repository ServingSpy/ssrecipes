...
execute if block ~ ~ ~ redstone_wire unless block ~ ~ ~ redstone_wire[power=0] unless block ~ ~ ~ redstone_wire[north=none] run return 1

execute if block ~ ~ ~ #ss_recipes:powered_is_boolean_and_non_directional[powered=true] run return 1
execute if block ~ ~ ~ observer[powered=true,facing=south] run return 1
execute if block ~ ~ ~ repeater[powered=true,facing=south] run return 1
execute if block ~ ~ ~ comparator[powered=true,facing=south] run return 1
