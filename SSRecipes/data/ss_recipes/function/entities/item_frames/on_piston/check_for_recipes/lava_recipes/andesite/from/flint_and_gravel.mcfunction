execute at @n[type=item,dx=1,dy=1,dz=1, nbt={Item:{id: "minecraft:gravel"}}, tag=!ss_recipesRecentlyCrushMade] run summon item ~ ~ ~ {Item:{id:"minecraft:andesite", count: 1}, Tags:["ss_recipesRecentlyCrushMade"]}
