#Dev Note: Redstone Torches, comparators, and repeaters don't power from above
    #Additionally, I don't know of a way to detect when trapped chests are creating power... so we might just have to forgo that
...
execute if block ~ ~ ~ observer[powered=true,facing=up] run return 1
